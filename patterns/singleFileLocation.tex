...
%                 registry Windows
%Peter: 2 patterns?
%Unknown4: Constrained by the OS?
%Leo: Name clear? (all files should have a single structure?)
%Leo: Fig. 4: same as Fig. 1 comments -->
%Leo: notation not conform UML 2; Not clear: package, component, interface
...
%Unknown4: -Embedded Resource (As an extra item)
...
If the folder structures are standardized
%Unknown4: ? (w.r.t. standardized)
