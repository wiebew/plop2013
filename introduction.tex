...
%Rebecca: This (But there is ...) is the heart of your reasons for writing these patterns, but it is burried here. Should be upfront. Intro is way too long. (Roland / Christian)
...
\begin{itemize}
	...
	%Not meant for an intro: The Building Blocks Model is primarily a \textit{decomposition} tool. That means that it is used to dissect infrastructure landscapes into logical dimensions and parts in order to enable structured and methodological modeling (\textit{composition}). 
	...
	%Not meant for an intro: It also explores in detail the advantages and limitations of asynchronous messaging architectures. 
\end{itemize}
